    ...
    const fetchCartData = async () => {
      ...
      try {
        ...
        const storedSelectedItems =
          JSON.parse(localStorage.getItem("selectedItems")) || allCartIds;
        setSelectedItems(storedSelectedItems);
        calculateTotal(response.items, storedSelectedItems);
      ...
      <div className="shopping-cart-details">
        ...
        {cartItems.map((item, index) => (
          <div key={item.productId} className="shopping-cart-product-card">
            ...
            />
            <img
              src={item.productImages[0] || "default-image-url"}
        ...
        <div className="shopping-cart-price-summary">
          <h3 className="shopping-cart-price-summary-heading">Price Summary</h3>
