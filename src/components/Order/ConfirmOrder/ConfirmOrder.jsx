...
const ConfirmOrder = () => {
  ...
  useEffect(() => {
    const fetchDetails = async () => {
      ...
      const singleProductFlag = localStorage.getItem("isSingleProduct") === "true";
      ...
      <div className="section1">
        ...
        {addressVisible && selectedAddress && (
          <div className="address-details1">
            <p><b>Cust Name:</b> {selectedAddress.custName}</p>
            <p><b>Mobile No:</b> {selectedAddress.mobileNo}</p>
            <p><b>Flat No:</b> {selectedAddress.flatNo}</p>
            <p><b>Area:</b> {selectedAddress.area}</p>
            <p><b>City:</b> {selectedAddress.city}</p>
            <p><b>State Name:</b> {selectedAddress.stateName}</p>
            <p><b>Pin Code:</b> {selectedAddress.pinCode}</p>
            <p><b>Country:</b> {selectedAddress.country}</p>
          </div>
        )}
      </div>
